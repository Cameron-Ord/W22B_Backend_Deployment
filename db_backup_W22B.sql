...
INSERT INTO `client` VALUES (1,'Cameron','email@email.com','password','image_input','bio'),(5,'Matthew','test@test.com','password','totally an image','bio'),(6,'arthas','arthas@outlook.com','password','https://i.imgur.com/EicUyOv.png','bio'),(7,'cameron2','email@outlook.com','password','https://i.imgur.com/EicUyOv.png','bio');
...
BEGIN
	...
	from login inner join client on client_id = client.id where token = token_input;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
